...
```sh
git clone https://github.com/BAMresearch/nomad-parser-fireworks.git
cd nomad-parser-fireworks
...
```sh
pip install dist/nomad-parser-fireworks-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Jose M. Pizarro | [jose.pizarro-blanco@bam.de](mailto:jose.pizarro-blanco@bam.de)
